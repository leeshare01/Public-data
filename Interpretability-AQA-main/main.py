...
# import wandb
import os
# 强制让PyTorch只识别你的RTX 4050（设备编号0）
os.environ["CUDA_VISIBLE_DEVICES"] = "0"
# 解决Windows下CUDA初始化常见的内存分配问题
...
def main(cfg):
    ...
    base_logger = get_logger(f'exp/{timestamp}_{cfg.seed}_{cfg.dataset_name}_{cfg.label}_{cfg.att_loss}_{cfg.dino_loss}_{cfg.query_var}_{cfg.pe}.log', "EXP1")    
